...
# Setup script untuk Railway deployment
# Script ini akan mempersiapkan semua file yang diperlukan
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}🚀 Setup Railway Deployment${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""

# Generate JWT Secret
echo "Generating JWT Secret..."
JWT_SECRET=$(openssl rand -base64 32 2>/dev/null || echo "BEM_FSRD_ISI_YOGYAKARTA_2025_SECRET_KEY_$(date +%s)")

# Create backend env template for Railway
cat > backend/.env.railway << EOF
# Railway Production Environment Variables
# Copy values ini ke Railway Dashboard → Backend Service → Variables tab

NODE_ENV=production
PORT=10000

# Database - Gunakan format \${{MySQL.MYSQLHOST}} untuk reference ke MySQL service
# Atau isi langsung dengan credentials dari MySQL service
...
# Ganti dengan URL frontend Anda setelah deploy
FRONTEND_URL=https://your-frontend-url.railway.app
EOF

echo -e "${GREEN}✅ Backend env template created: backend/.env.railway${NC}"

# Create frontend env template for Railway
cat > frontend/.env.railway << EOF
# Railway Production Environment Variables
# Copy values ini ke Railway Dashboard → Frontend Service → Variables tab

# API URL - Ganti dengan URL backend Anda setelah deploy backend
...
echo -e "${GREEN}✅ Frontend env template created: frontend/.env.railway${NC}"

# Create deployment instructions
cat > RAILWAY_SETUP_NOW.md << 'INSTRUCTION_EOF'
...
echo -e "${GREEN}✅ Deployment instructions created: RAILWAY_SETUP_NOW.md${NC}"
echo ""
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${YELLOW}📝 File yang sudah dibuat:${NC}"
echo "   ✅ backend/.env.railway - Environment variables untuk backend"
echo "   ✅ frontend/.env.railway - Environment variables untuk frontend"
echo "   ✅ RAILWAY_SETUP_NOW.md - Instruksi deployment lengkap"
echo ""
echo -e "${BLUE}🚀 Next Steps:${NC}"
echo "   1. Baca file: RAILWAY_SETUP_NOW.md"
echo "   2. Ikuti langkah-langkah di Railway Dashboard"
echo "   3. Website akan online dalam 15-20 menit!"
echo ""
echo -e "${YELLOW}📋 Quick Start:${NC}"
echo "   1. Buka: https://railway.app/dashboard"
echo "   2. Login dengan GitHub"
echo "   3. New Project → Deploy from GitHub repo"
echo "   4. Ikuti instruksi di RAILWAY_SETUP_NOW.md"
echo ""
